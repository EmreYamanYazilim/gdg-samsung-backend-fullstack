...
@section('title', 'YMNyazilimAnasayfa')
...
@section('body')
    <section class="slider position-relative bg-orange mt-2"><!-- positionları yakalamak için relative verdim -->
    ...
    <section class="feature-brands position-relative mt-5">
        <div class="container">
            <div class="row">
                <div class="col-12 position-relative"> <!-- scroll buttonları  yakalayıp hizalamak için relative verdim-->
